using eSya.InterfaceEmail.WebAPI.Utility;
using eSya.InterfaceEmail.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_InterfaceEmail = eSya.InterfaceEmail.DL.Entities;
using eSya.InterfaceEmail.IF;
using eSya.InterfaceEmail.DL.Repository;
using Microsoft.Extensions.Localization;
using eSya.InterfaceEmail.DL.Localization;
...
DL_InterfaceEmail.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
